(function () {
  ...
  const KB = [
    ...
    },
    {
      ...
      response: () => `${greet()}<strong>🌆 Good Evening!</strong><br><br>Hope your day went well! Evening is actually a great time to think about financial planning — the day's work is done and you have a few quiet moments. 😊<br><br>I'm Rakesh, here to help with any insurance or financial questions.<br><br>What can I help you with today?`,
    ...
    },
    {
      ...
      response: () => `${greet()}Namaste! 🙏 Bahut swagat hai PolicyRaj mein!<br><br>Main hoon Rakesh — aapka AI Insurance Advisor. Aap mujhse koi bhi sawaal Hindi ya English mein puch sakte hain!<br><br>Aaj main aapki kaise madad kar sakta hoon?`,
  ...
  function handleNameIntro(text) {
    ...
    if (m && m[1].length > 1 && !['am','just','here','from','at','not','the','a'].includes(m[1].toLowerCase())) {
      ctx.userName = m[1].charAt(0).toUpperCase() + m[1].slice(1).toLowerCase();
      botReply(
        `Nice to meet you, <strong>${ctx.userName}!</strong> 😊 I'm Rakesh, your PolicyRaj AI advisor.<br><br>How can I help you today, ${ctx.userName}? Whether it's insurance, investments, tax saving, or any money question — I'm all ears!`,
  ...
  window.toggleChat = function () {
    ...
    if (chatOpen) {
      ...
      if (!welcomed) {
        ...
        setTimeout(() => {
          botReply(
            `Namaste! 🙏 I'm <strong>Rakesh</strong>, your AI insurance advisor at PolicyRaj!<br><br>I can help you with <em>anything</em> — insurance plans, investments, tax saving, claims, premiums, or just general money advice. Feel free to ask me anything! 😊<br><br>What's on your mind today?`,
